...
import { IN, AE, CA } from 'country-flag-icons/react/3x2'
      ...
      <Container>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 py-12'>
          ...
          <div className='space-y-4'>
            <SubTitle className='text-white text-xl'>We Are At</SubTitle>

            <SubText className='text-white/80 leading-relaxed'>
              Amber Gem Tower One, CWS-2V-228017, 26th floor, Sheikh Khalifa
              Street, Rashideya 3, Ajman, United Arab Emirates.
            </SubText>
          </div>

          {/* Quick Links */}
          <div className='space-y-4'>
            <SubTitle className='text-white text-xl'>Quick Links</SubTitle>
          ...
          <div className='space-y-5'>
            <div className='space-y-2'>
              <SubTitle className='text-white text-xl'>Email</SubTitle>
            ...
            <div className='space-y-2'>
              <SubTitle className='text-white text-xl'>Phone</SubTitle>

              <div className='flex flex-col gap-6'>
                <SubText className='flex items-center gap-2 text-white/80'>
                  <IN title='India' className='w-7 h-7 rounded-md' />
                   +91 9538 409 062
                </SubText>

                <SubText className='flex items-center gap-2 text-white/80'>
                  <AE title='UAE' className='w-7 h-7 rounded-md' />
                  +971-52 148 6040
                </SubText>

                <SubText className='flex items-center gap-2 text-white/80'>
                  <CA title='Canada' className='w-7 h-7 rounded-md' />
                  <span>+1-506 471 2650</span>
                </SubText>
              </div>
            </div>
          </div>
